...
function t7() {
    document.querySelector('.out-7').innerHTML += a7[Math.floor(0 + Math.random() * (a7.length - 1 + 1 - 0))];
...
function t8(event) {
    ...
    if(event.key == 'i') out = a8['i'];
    else if(event.key == 'o') out = a8['o'];
    else if(event.key == 'l') out = a8['l'];
    else out = event.key;
...
function t11(event) {
    ...
    for(let i of keyboard){
        if(event.key == i.innerHTML) i.classList.add('active');
        if(event.keyCode == 13 && i.innerHTML == 'enter') i.classList.add('active');
        if(event.keyCode == 17 && i.innerHTML == 'ctrl') i.classList.add('active');
        if(event.keyCode == 18 && i.innerHTML == 'alt') i.classList.add('active');
        if(event.keyCode == 32 && i.innerHTML == 'space') i.classList.add('active');
    }
