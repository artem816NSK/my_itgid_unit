...
function t1() {
    ...
    document.querySelector('.out-1').innerHTML = div1.innerHTML;
...
function t4() {
    ...
    document.querySelector('.out-4').innerHTML = div4.innerHTML;
...
// ваше событие здесь!!!
document.querySelector('.ch-8').addEventListener('click', t8);
...
function t19() {
    ...
    div19.innerHTML = div19.className;
}
// ваше событие здесь!!!
