...
document.querySelector('.three').innerHTML = '<h3>Hello, Mars</h3>';
...
document.querySelector('.four').innerHTML = '<h4>Hello, Mars</h4>';
document.querySelector('.four').innerHTML += '<p>Привет, марсиане</p>';
