...
let ar3 = [];
let length = Math.floor(1 + Math.random() * (50 + 1 - 1));

for(let i = 0; i < length; i++){
    ar3.push(Math.floor(1 + Math.random() * (50 + 1 - 1)));
}
...
function f11() {
    ...
    document.querySelector('.out-11').innerHTML = ar11[2] + ' ' + ar11[4];
...
function f12() {
    ...
    document.querySelector('.out-12').innerHTML = ar12[0] + ' ' + ar12[ar12.length - 1];
...
function f13() {
    ...
    document.querySelector('.out-13').innerHTML = result;
...
function f16() {
    for(let i = 0; i < ar16.length; i++){
        if(ar16[i] % 2 == 0) ar16_even[i] = ar16[i];
        else ar16_odd[i] = ar16[i];
    }
