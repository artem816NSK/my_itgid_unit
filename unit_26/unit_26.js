...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=5&num2=25')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=100&num2=999')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=13&num2=28')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t10() {
    ...
    .then(responce => document.querySelector('.out-10').innerHTML = responce);
}
...
function t11() {
    ...
    .then(response => response.text())
    .then(responce => document.querySelector('.out-11').innerHTML = responce);
}
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=DdC33D7d2C2a7&action=3&num1=55&num2=3',
    })
    .then(response => response.text())
    .then(responce => document.querySelector('.out-12').innerHTML = responce);
}
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=DdC33D7d2C2a7&action=4&num1=0&num2=3',
    })
    .then(response => response.text())
    .then(responce => document.querySelector('.out-13').innerHTML = responce);
}
...
function t14() {
    ...
    .then(response => response.text())
    .then(responce => document.querySelector('.out-14').innerHTML = responce);
}
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=DdC33D7d2C2a7&action=6&num1=4&num2=1',
    })
    .then(response => response.text())
    .then(responce => document.querySelector('.out-15').innerHTML = responce);
}
...
function t16() {
    ...
    .then(response => response.text())
    .then(responce => document.querySelector('.out-16').innerHTML = responce);
}
...
function t17() {
    ...
    .then(response => response.text())
    .then(responce => document.querySelector('.out-17').innerHTML = responce);
}
...
function t18() {
    ...
    .then(response => response.text())
    .then(responce => document.querySelector('.out-18').innerHTML = responce);
}
