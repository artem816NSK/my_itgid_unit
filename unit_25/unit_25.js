...
function onReadyStateChange(xhttp, out){
    return xhttp.onreadystatechange = () => {
        if(xhttp.readyState == 4 && xhttp.status == 200){
           document.querySelector(out).innerHTML = xhttp.responseText;
        }
    }
}
...
function t1() {
    onReadyStateChange(xhttp, '.out-1');
...
function t2() {
    onReadyStateChange(xhttp, '.out-2');

    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Artem', true);
    xhttp.send();
}
...
function t3() {
    onReadyStateChange(xhttp, '.out-3');
...
function t4() {
    onReadyStateChange(xhttp, '.out-4');

    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=3&num2=67', true);
    xhttp.send();
}
...
function t5() {
    onReadyStateChange(xhttp, '.out-5');
...
function t6() {
    onReadyStateChange(xhttp, '.out-6');

    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=90&num2=32', true);
    xhttp.send();
}
...
function t7() {
    onReadyStateChange(xhttp, '.out-7');
...
function t8() {
    onReadyStateChange(xhttp, '.out-8');

    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1995', true);
    xhttp.send();
}
...
function t9() {
    onReadyStateChange(xhttp, '.out-9');
...
function t10() {
    onReadyStateChange(xhttp, '.out-10');
...
function t11() {
    onReadyStateChange(xhttp, '.out-11');

    xhttp.open('POST', 'http://getpost.itgid.info/index2.php', true)
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=DdC33D7d2C2a7&action=2&name=Artem');
}
...
function t12() {
    onReadyStateChange(xhttp, '.out-12');

    xhttp.open('POST', 'http://getpost.itgid.info/index2.php', true)
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=DdC33D7d2C2a7&action=3&num1=2&num2=101');
}
...
function t13() {
    onReadyStateChange(xhttp, '.out-13');

    xhttp.open('POST', 'http://getpost.itgid.info/index2.php', true)
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=DdC33D7d2C2a7&action=4&num1=3&num2=1034');
}
...
function t14() {
    onReadyStateChange(xhttp, '.out-14');
...
function t15() {
    onReadyStateChange(xhttp, '.out-15');

    xhttp.open('POST', 'http://getpost.itgid.info/index2.php', true)
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=DdC33D7d2C2a7&action=6&num1=150&num2=30');
}
...
function t16() {
    onReadyStateChange(xhttp, '.out-16');
...
function t17() {
    onReadyStateChange(xhttp, '.out-17');

    xhttp.open('POST', 'http://getpost.itgid.info/index2.php', true)
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=DdC33D7d2C2a7&action=8&year=1995');
}
...
function t18() {
    onReadyStateChange(xhttp, '.out-18');
