...
function f4() {
    ...
    if(i4.checked) out4.innerHTML = true;
...
function f5() {
    ...
    if(i5.checked) out5.innerHTML = i5.value;
...
function f7() {
    ...
    if(i7.length >= 6) out72.innerHTML = 1;
...
function f8() {
    ...
    out8.innerHTML = '<input type="text" class="i-81"></input>';
    out8.innerHTML += '<button class="b-81">Кнопка</button>'
...
function f81 () {
    ...
    let out81 = document.querySelector('.out-81').innerHTML = i81;
...
function f9() {
    ...
    if(r9.checked) out9.innerHTML = r9.value;
    else out9.innerHTML = 0;
}
